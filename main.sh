...
output_option '请选择要安装的平台' 'Docker K8S系统 Rancher平台(k8s集群管理)' 'virtualization'

for number in ${virtualization[@]}; do
	case "$number" in
