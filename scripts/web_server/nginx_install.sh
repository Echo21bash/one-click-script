...
nginx_compile(){
	...
	if [[ ${add_module[*]} =~ '1' ]];then
		...
		down_file https://github.com/happyfish100/fastdfs-nginx-module/archive/refs/tags/V1.21.tar.gz fastdfs-nginx-module-1.21.tar.gz && tar zxf fastdfs-nginx-module-1.20.tar.gz
